...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default= ROOT / "models/yolov5s_plant.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/plant.yaml" , help="dataset.yaml path")
